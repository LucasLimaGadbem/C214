...
exports.MemoizedCompareValuesWithDetailedDifferences = exports.CompareValuesWithDetailedDifferences = void 0;
 ...
 */
const CompareValuesWithDetailedDifferences = (firstObject, secondObject, pathOfConflict = '', options = {}) => {
    ...
    return _CompareValuesWithDetailedDifferences(firstObject, secondObject, pathOfConflict, options);
};
exports.CompareValuesWithDetailedDifferences = CompareValuesWithDetailedDifferences;
/**
 * Internal implementation of CompareValuesWithDetailedDifferences
 * This is separated to allow for memoization
 */
const _CompareValuesWithDetailedDifferences = (firstObject, secondObject, pathOfConflict = '', options = {}) => {
    // Extract options
    ...
    if (pathFilter && pathFilter.mode === 'include') {
        ...
        const comparePropertiesRecursively = (first, second, currentPath) => {
                                ...
                                if (propPattern) {
                                    ...
                                    if (typeof first[i] === 'object' && first[i] !== null &&
                                        ...
                                        if (propKey in first[i] && propKey in second[i]) {
                                            if (!(0, utils_1.areValuesEqual)(first[i][propKey], second[i][propKey], options.strict)) {
                                                differences.push({
                                                    path: `[${i}]${propPattern}`,
                                                    type: 'changed',
                                                    oldValue: first[i][propKey],
                                    ...
                                    // Match the entire element
                                    if (!(0, utils_1.areValuesEqual)(first[i], second[i], options.strict)) {
                                        differences.push({
                                            path: elemPath,
                                            type: 'changed',
                                            oldValue: first[i],
            ...
            if (!(0, path_filtering_1.shouldComparePath)(currentPath, pathFilter)) {
            ...
            if (typeof first !== 'object' || first === null ||
                ...
                if (!(0, utils_1.areValuesEqual)(first, second, options.strict)) {
                    differences.push({
                        path: currentPath,
                        type: 'changed',
                        oldValue: first,
    ...
    try {
        ...
        const differences = (0, value_comparison_1.handleDepthComparison)(firstObject, secondObject, pathOfConflict, options, false, true);
        if (!Array.isArray(differences)) {
            return [];
        }
        // Type assertion because we know the differences will be DetailedDifference objects due to detailed=true parameter
        const detailedDifferences = differences;
        ...
        if (pathFilter && pathFilter.patterns && pathFilter.patterns.length > 0) {
            return detailedDifferences.filter(diff => {
                ...
                const matchesPattern = !(0, path_filtering_1.shouldComparePath)(diff.path, pathFilter);
 ...
 */
exports.MemoizedCompareValuesWithDetailedDifferences = (0, memoization_1.Memoize)(exports.CompareValuesWithDetailedDifferences, memoization_1.compareValuesWithDetailedDifferencesKeyFn);

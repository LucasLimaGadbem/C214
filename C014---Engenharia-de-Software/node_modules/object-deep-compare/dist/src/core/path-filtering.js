...
exports.shouldComparePath = exports.shouldFilterPath = exports.matchesPathPattern = void 0;
/**
 ...
 */
const matchesPathPattern = (path, patterns) => {
 ...
 */
const shouldFilterPath = (path, pathFilter) => {
    ...
    if ((0, exports.matchesPathPattern)(path, pathFilter.patterns)) {
        return true;
    }
    ...
    for (const part of parts) {
        ...
        if (arrayMatch) {
            ...
            if ((0, exports.matchesPathPattern)(currentPath, pathFilter.patterns)) {
                return true;
            }
...
exports.shouldFilterPath = shouldFilterPath;
/**
 ...
 */
const shouldComparePath = (path, pathFilter) => {
    if (!pathFilter || !pathFilter.patterns || pathFilter.patterns.length === 0) {
    ...
    if (mode === 'exclude') {
        return !(0, exports.shouldFilterPath)(path, pathFilter);
    }
    ...
    if ((0, exports.shouldFilterPath)(path, pathFilter)) {
        return true;
    }
...
exports.shouldComparePath = shouldComparePath;
